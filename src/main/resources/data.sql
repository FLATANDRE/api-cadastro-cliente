...
INSERT INTO perfil (id, nome, codigo, hierarquia) VALUES 
(1, 'Administrador' ,'ADM', 8),
(2, 'Administrador AICare' ,'ADA', 9),
(3, 'Gestor Manutenção' ,'GMN', 0),
(4, 'Gestor Comercial' ,'GCM', 0),
(5, 'Implementador Geral' ,'IMG', 0),
(6, 'Implementador Automático' ,'IMA', 0),
(7, 'Operador Manutenção' ,'OPM', 0),
(8, 'Processador de eventos' ,'PEV', 0);

SELECT setval('perfil_seq', 8);

-- Tipos de dispositivos
INSERT INTO tipo_dispositivo (id, nome, codigo, associavel_equipamento, associavel_localizacao) VALUES 
    (1, 'Desconhecido' ,'uk', false, false),
    (2, 'Local point gateway' ,'lpgw', false, true),
    (3, 'Rastreador de equipamento' ,'et', true, false);

SELECT setval('tipo_dispositivo_seq', 3);

-- Fabricantes e modelos
INSERT INTO fabricante_dispositivo (id, nome) VALUES 
    (1, 'Desconhecido');
SELECT setval('fabricante_dispositivo_seq', 1);

INSERT INTO modelo_dispositivo (id, nome, tensao_min_bat, tensao_max_bat, fabricante, desconhecido) VALUES 
    (1, 'Desconhecido', 2.5, 3.0, 1, true);
SELECT setval('modelo_dispositivo_seq', 1);

INSERT INTO fabricante_equipamento (id, nome) VALUES 
    (1, 'Desconhecido');
SELECT setval('fabricante_equipamento_seq', 1);

INSERT INTO modelo_equipamento (id, nome, fabricante) VALUES 
    (1, 'Desconhecido', 1);
SELECT setval('modelo_equipamento_seq', 1);

-- Natureza vinculo
INSERT INTO natureza_vinculo (id, nome) VALUES 
    (1, 'Estágio Profissional'),
    (2, 'Trabalhador Autônomo'),
    (3, 'Trabalhador Eventual'),
    (4, 'Celetista');

SELECT setval('natureza_vinculo_seq', 4);

-- Tipo compartimento
INSERT INTO tipo_compartimento (id, nome) VALUES 
    (1, 'Sala'),
    (2, 'Manutenção'),
    (3, 'Corredor'),
    (4, 'Leito'),
...
SELECT setval('tipo_compartimento_seq', 5);

-- Tipo container
INSERT INTO tipo_container (id, nome) VALUES 
    (1, 'Geladeira'),
    (2, 'Armário');

SELECT setval('tipo_container_seq', 2);

-- Tipo bomba
INSERT INTO tipo_bomba (id, nome) VALUES 
    (1, 'Grande volume'),
    (2, 'ACP'),
    (3, 'Elastomérica'),
    (4, 'Seringa'),
...
SELECT setval('tipo_bomba_seq', 6);

-- Tipo manutenção
INSERT INTO tipo_manutencao (id, nome) VALUES 
    (1, 'Preventiva obrigatória'),
    (2, 'Preventiva não obrigatória'),
    (3, 'Calibração'),
    (4, 'Corretiva');

SELECT setval('tipo_manutencao_seq', 4);
...
SELECT setval('profissao_seq', 768);

-- Pais , estados e cidades
INSERT INTO pais (id, nome, sigla) VALUES
(1, 'Brasil', 'br');

SELECT setval('pais_seq', 1);
