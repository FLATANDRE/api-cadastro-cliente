...
INSERT INTO perfil (id, nome, codigo) VALUES 
(1, 'Administrador' ,'admin'),
(2, 'Administrador AICare' ,'admin_aicare'),
(3, 'Gestor Manutenção' ,'gestor_manutencao'),
(4, 'Gestor Comercial' ,'gestor_comercial'),
(5, 'Implementador Geral' ,'implementador_geral'),
(6, 'Implementador Automático' ,'implementador_automatico'),
(7, 'Operador Manutenção' ,'operador_manutencao');

SELECT setval('perfil_seq', 7);

-- Tipos de dispositivos
INSERT INTO tipo_dispositivo (id, nome, codigo) VALUES 
    (1, 'Desconhecido' ,'uk'),
    (2, 'Local point roteador' ,'lpgw'),
    (3, 'Rastreador de equipamento' ,'et');
...
SELECT setval('fabricante_seq', 2);

-- Modelos
INSERT INTO modelo (id, nome, tensao_min_bat, tensao_max_bat, fabricante) VALUES 
    (1, 'Desconhecido', 2.5, 3.0, 1),
    (2, 'C7', 2.5, 3.0, 2),
    (3, 'G1', 0, 0, 2);

SELECT setval('modelo_seq', 2);
